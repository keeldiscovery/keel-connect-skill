...
|---|---|---|---|
| Claude Code | 2.1.268 (journey), 2.1.270 (instruction eval) | the matrix (macOS and Windows, short journey per change, the full journey weekly); the instruction eval pinned per class -- `sonnet` on assumptions and briefs, `haiku` on readings (measured as `claude-sonnet-5` / `claude-haiku-4-5-20251001`, `keel-e2e-eval-screens/runs/20260913T024219Z-instructions`, 393 cases × 3: anchoring 96.5 %, recall 85.6 %, refusals 0, brief 20/21 on one "proxy" since forbidden in the prompt; five timeouts under load) -- keel-cloud CANON.md waiver W-042-3, the founder's call; the earlier run of record on the account default was marks v3 | 2026-09-13 |
| Copilot CLI | 1.0.83 | the matrix (macOS and Windows, the full journey, 2026-09-12); the instruction eval pinned per class -- certified pair `gpt-6-astra` on assumptions and briefs, `gpt-5.4-mini` on readings, on the one-entry screen (`keel-e2e-eval-copilot/runs/20260913T103927Z-instructions-copilot`, 48 cases × 3: anchoring 100 %, recall 87.0 %, refusals 0, brief 3/3), beside the full run of record on `gpt-5.6-luna`/`gpt-5-mini` (`…/20260913T023819Z-instructions-copilot`, 393 × 3: anchoring 95.0 %, recall 84.1 %, refusals 0, brief 21/21, one shape refusal the product corrected) -- keel-cloud CANON.md waiver W-042-2, the founder's call | 2026-09-13 |
| Codex CLI | 0.154.0 | the matrix (macOS and Windows, the full journey, run 34713021574, 2026-09-12); the instruction eval pinned per class -- `gpt-6-astra` on assumptions and briefs, `gpt-5.4-mini` on readings (`runs/20260913T024900Z-instructions-codex`, 393 cases × 3: anchoring 96.2 %, recall 93.9 %, refusals 0, brief 20/20 answered; 13 of 1,179 case-runs unrun when the API account ran out of credits -- keel-cloud CANON.md waiver W-042-1, the founder's call) | 2026-09-13 |
